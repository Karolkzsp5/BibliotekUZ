...
- Utwórz projekt React z create-vite: `npm init --yes vite@latest bibliotekuz.client -- --template=react  --no-rolldown --no-immediate`.
...
- Utwórz plik projektu (`bibliotekuz.client.esproj`).
